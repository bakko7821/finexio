...
- Изменены GET эндпоинты на вывод инофрмации для пончика (теперь выводиться 5 самых больших категорий, а все остальное попадает в категорию - Другое)

### Клиентская часть

- Измен вывод tooltips для пончика, теперь данные кастомно выводятся, красиво и поверх блока с категориями

# commit 16.23.1

- Создана страница изменения категории

# commit 17.24.1

### Серверная часть

- Создан PUT эндпоинт на изменение категории

### Клиентская чать

- Создана форма для изменения категории
- Для правильной авторизации все запросы получили строгий конфиг в файле **/utils/api.ts**
- Все axios запросы измененны на api запросы из конфига

# commit 18.25.1

### Серверная часть

- Создан DELETE эндпоинт для удаления категории
- Создана заглушка для удаленной категории

### Клиентская часть

- Создан новый слайс для удаления категории через RTK

# commit 19.26.1

### Серверная часть

- Создан PUT эндпоинт для изменения транзакции
